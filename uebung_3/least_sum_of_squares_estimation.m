function [theta, c] = least_sum_of_squares_estimation(pixellist)
    % Total Least Squares, um den orthogonalen Abstand zu minimieren
    % Bestimme die Parameter der Linie in hessescher Normalform
    % c = x*cos(theta)+y*sin(theta)
    % Der Code funktioniert korrekt!
    
    % Herleitung des Eigenwertproblems: Siehe Skript 04_Curvefitting.pdf S.
    % 27 ff.    
